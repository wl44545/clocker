...
export class TimerService {
  ...
  public editEntry(entry: TimeEntryModel): Observable<TimeEntryModel>{
    return this.httpClient.put<TimeEntryModel>(`${environment.apiUrl}/post/updatepost/${entry.id}/${entry.description}/${entry.user}/${entry.start}/${entry.stop}/${entry.project}/${entry.active}/${this.loginService.getToken()}`, entry, this.loginService.getAuthorizedOptions());
  }

  public removeEntry(entry: TimeEntryModel): Observable<TimeEntryModel>{
    return this.httpClient.delete<TimeEntryModel>(`${environment.apiUrl}/post/removepost/${entry.id}/${this.loginService.getToken()}`, this.loginService.getAuthorizedOptions());
  }

  public updateActive(id:number, timeModel: TimeLocalModelRequest): Observable<TimeEntryModel>{
    return this.httpClient.put<TimeEntryModel>(`${environment.apiUrl}/post/updatepost/${id}/${timeModel.description}/${timeModel.user}/${timeModel.start}/${timeModel.stop}/${timeModel.project}/${timeModel.active}/${this.loginService.getToken()}`,timeModel, this.loginService.getAuthorizedOptions());
  }
}
